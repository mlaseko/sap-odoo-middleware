...
public class AutohubBulkSkipTests
{
    ...
    // Only _docs and _review are exercised by bulk-skip; the rest (incl. the Autohub SAP service, the Neon
    // bridge, and the manufacturer-resolution client) are not invoked.
    private static AutohubDocumentsController Build(Mock<IStagingPartsDocumentRepository> docs, Mock<IPartsReviewRepository> review)
        => new(docs.Object, review.Object, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!);
